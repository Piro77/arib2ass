...
static void dumpheader(decoder_t *p_dec)
{
    ...
    if (fp == NULL) {
        ...
        printf("Style: Default,ＭＳ　ゴシック,36,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,4,0,1,2,2,7,0,0,0,0\r\n");
        printf("Style:    Half,ＭＳ　ゴシック,36,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,50,100,4,0,1,2,2,7,0,0,0,0\r\n");
        printf("Style:    Rubi,ＭＳ　ゴシック,18,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,2,0,1,2,2,7,0,0,0,0\r\n");
